 ...
 * Generated at: 2018-08-11 06:17:19 UTC
...
return;
    ...
    try {
      ...
      out.write("                </div>\r\n");
      out.write("                <form id=\"loginForm\" class=\"am-form tpl-form-line-form\" action=\"/user/login.do\" method=\"post\">\r\n");
      out.write("                    <div class=\"am-form-group\">\r\n");
      out.write("                        <input type=\"text\" class=\"tpl-form-input\" id=\"user-name\" name=\"userName\" value=\"");
      ...
      out.write("\" placeholder=\"请输入账号\" autocomplete=\"off\">\r\n");
      out.write("                    </div>\r\n");
      out.write("\r\n");
      out.write("                    <div class=\"am-form-group\">\r\n");
      out.write("                        <input type=\"password\" class=\"tpl-form-input\" id=\"user-pwd\" name=\"pwd\"  placeholder=\"请输入密码\">\r\n");
      out.write("                    </div>\r\n");
      out.write("\r\n");
      out.write("                    <div class=\"am-form-group\">\r\n");
      out.write("                        <input type=\"text\" class=\"tpl-form-input\" id=\"captcha\" name=\"captcha\" placeholder=\"请输入验证码\">\r\n");
      out.write("                        <img src=\"/getCaptcha.do\" id=\"captchaImg\">\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <div class=\"am-form-group\">\r\n");
      out.write("\r\n");
      out.write("                        <button type=\"button\" onclick=\"f()\" class=\"am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn\">登录</button>\r\n");
      out.write("                        <button type=\"button\" onclick=\"Wx()\" class=\"am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn\">微信登录</button>\r\n");
      out.write("                        <button type=\"button\" onclick=\"window.location.href='/skip/tologinUp.do'\" class=\"am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn\">注册</button>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("                    </div>\r\n");
      out.write("                </form>\r\n");
      ...
      out.write("                if (result.code==1000) {\r\n");
      out.write("                    window.location.href=\"/skip/index.do\";\r\n");
      out.write("                } else {\r\n");
      out.write("                    alert(result.message);\r\n");
      out.write("                    $(\"#captchaImg\").attr('src', '/getCaptcha.do?' + new Date().getTime());\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        })\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function Wx() {\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            type: \"post\",\r\n");
      out.write("            dataType: \"json\",\r\n");
      out.write("            url: '/Wx/getCodeUrl.do',\r\n");
      out.write("            success: function (dataResult) {\r\n");
      out.write("                if (1000 == dataResult.code) {\r\n");
      out.write("                    window.location.href= dataResult.data;\r\n");
      out.write("                }else{\r\n");
