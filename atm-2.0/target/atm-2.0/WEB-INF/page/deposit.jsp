                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                <form class="am-form tpl-form-line-form" id="form1" action="/card/deposit.do" method="post">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="money" name="money" autocomplete="off" placeholder="请输入存款金额">
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-sm-push-3">
                                            <button type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success " onclick="commit()">存款</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
